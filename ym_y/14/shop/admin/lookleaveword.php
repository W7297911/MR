  ...
  <tr> 
    <td height="40" colspan="2" bgcolor="#333333"><table width="750"  border="0" align="center" cellpadding="0" cellspacing="1">
		 ...
		 <?php
		   ...
		   if ($total<=$pagesize){
			...
			if(!isset($_GET['page'])){
			 ...
			 $sql1=mysqli_query($conn,"select * from tb_leaveword  order by time desc limit ".($page-1)*$pagesize.",$pagesize ");
        ...
        <tr> 
		  ...
		  <?php
		   $sql2=mysqli_query($conn,"select name from tb_user where id='".$info1['userid']."'");
