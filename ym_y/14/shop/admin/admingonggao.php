    ...
    <td width="547"><div align="right">
	 ...
	 <?php
        ...
        <?php
		  ...
		  {
		  ?>
        <a href="admingonggao.php?id=<?php echo $info1['id'];?>&page=1" title="首页"><font face="webdings"> 9 </font></a> 
		<a href="admingonggao.php?id=<?php echo $info1['id'];?>&page=<?php echo $page-1;?>" title="前一页"><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
		    for($i=1;$i<=$pagecount;$i++){
		  ?>
        <a href="admingonggao.php?id=<?php echo $info1['id'];?>&page=<?php echo $i;?>"><?php echo $i;?></a>
        <?php
		     }
		   }else{
		   for($i=1;$i<=4;$i++){	 
        ...
        <a href="admingonggao.php?id=<?php echo $info1['id'];?>&page=<?php echo $i;?>"><?php echo $i;?></a>
        <?php }?>
        <a href="admingonggao.php?id=<?php echo $info1['id'];?>&page=<?php echo $page-1;?>" title="后一页"><font face="webdings"> 8 </font></a>
		 <a href="admingonggao.php?id=<?php echo $info1['id'];?>&page=<?php echo $pagecount;?>" title="尾页"><font face="webdings"> : </font></a>
        <?php }?>
		</div></td>
  </tr>
</table>
