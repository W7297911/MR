...
<table width="450" height="200" border="0" align="center" cellpadding="0" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#3399FF">
 ...
 <form name="form1" method="post" action="<?php echo $_SERVER["PHP_SELF"];?>" onSubmit="return chkinput(this)">
  ...
  <tr>
    <td height="25" colspan="2" bgcolor="#FFFFFF"><div align="center"><input type="hidden" name="id" value="<?php echo $_GET['id'];?>"><input type="submit" value="编辑" class="buttoncss" name="submit">&nbsp;&nbsp;<input type="reset" value="取消" class="buttoncss"></div></td>
  </tr>
  </form>
