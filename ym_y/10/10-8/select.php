	...
	<tr>
		...
		<table width="100%" height="27" border="0" cellpadding="0" cellspacing="0" background="images/link.jpg">
			<tr>
				...
				<td width="94" align="center" valign="middle"><a href="#" class="a">简单查询</a></td>
				<td width="91" align="center" valign="middle"><a href="#" class="a">高级查询</a></td>
				<td width="94" align="center" valign="middle"><a href="#" class="a">分组统计</a></td>
				<td width="93" align="center" valign="middle"><a href="#" class="a">退出系统</a></td>
			</tr>
		</table>
		</td>
	</tr>
